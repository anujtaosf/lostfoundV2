...
const UniqnameFormReturn = ({ setUniqname, setTrainings }) => {
  ...
  }, [uniqnameInput, handleTimeout]); // reset timer when user selects a uniqname
  ...
  return (
    <Checkout onSubmit={handleUniqnameSubmit}>
      ...
      <Description>
        <span>Please sign in with your uniqname</span>
        <br />
        <br />
        <span style={{ color: "gray", fontStyle: "italic" }}>
          If you don't see your uniqname, then you do not have any tools to return
        </span>
      </Description>
